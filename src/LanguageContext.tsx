...
const DICT: Record<string, { th: string; en: string }> = {
  ...
  tab_performance:      { th: 'ผลการดำเนินงาน', en: 'Performance' },
  ...
  cal_load_timeout:     { th: 'เชื่อมต่อช้าเกินไป กดรีเฟรชเพื่อลองใหม่', en: 'Connection timed out — tap Refresh to try again' },
  ...
  rev_updated:          { th: 'อัปเดตล่าสุด', en: 'Updated' },
  rev_refresh:          { th: 'รีเฟรช', en: 'Refresh' },
  rev_retry:            { th: 'ลองอีกครั้ง', en: 'Retry' },
  rev_load_error:       { th: 'โหลดข้อมูลไม่สำเร็จ', en: 'Failed to load data' },
  rev_no_data:          { th: 'ยังไม่มีข้อมูลรายรับ', en: 'No revenue data yet' },
  // ── Performance (PerformanceDashboard) — admin-only ──
  perf_title:           { th: '📈 ผลการดำเนินงาน', en: '📈 Performance' },
  perf_updated:         { th: 'อัปเดตล่าสุด', en: 'Updated' },
  perf_refresh:         { th: 'รีเฟรช', en: 'Refresh' },
  perf_retry:           { th: 'ลองอีกครั้ง', en: 'Retry' },
  perf_load_error:      { th: 'โหลดข้อมูลไม่สำเร็จ', en: 'Failed to load data' },
  perf_no_data:         { th: 'ยังไม่มีข้อมูลในสัปดาห์นี้', en: 'No data for this week' },
  perf_this_week:       { th: 'สัปดาห์นี้', en: 'This week' },
  perf_section_title:   { th: 'ผลการดำเนินงานรายสัปดาห์', en: 'Performance' },
  perf_metric_rooms:    { th: 'ห้องที่ขายได้', en: 'Rooms sold' },
  perf_metric_revenue:  { th: 'รายรับ', en: 'Revenue' },
  ...
  rev_kpi_latest:       { th: 'ล่าสุด', en: 'Latest' },
  rev_table_title:      { th: 'รายรับแยกเดือน / OTA (THB)', en: 'Revenue by month / OTA (THB)' },
  rev_col_month:        { th: 'เดือน', en: 'Month' },
  rev_col_total:        { th: 'รวม', en: 'Total' },
  ...
  ci_preview_mode:      { th: 'กำลังดูข้อมูลย้อนหลัง/ล่วงหน้า:', en: 'Previewing:' },
  ci_preview_readonly:  { th: '(ดูอย่างเดียว)', en: '(read-only)' },
  ci_preview_back_today:{ th: 'กลับวันนี้', en: 'Back to today' },
  ...
  ci_load_timeout:      { th: 'เชื่อมต่อช้าเกินไป กดรีเฟรชเพื่อลองใหม่', en: 'Connection timed out — tap Refresh to try again' },
  ...
  ci_move_room_title:   { th: 'ย้ายห้อง', en: 'Move room' },
  ci_move_room_new_room_label: { th: 'ห้องใหม่', en: 'New room' },
  ci_move_room_reason_label: { th: 'เหตุผล', en: 'Reason' },
  ci_move_room_select_placeholder: { th: '— เลือกห้อง —', en: '— Select room —' },
  ...
  ci_move_room_reason_other: { th: 'อื่นๆ', en: 'Other' },
  ...
  ci_manual_search_btn: { th: '🔍 ค้นหา/ยกเลิก booking อื่น', en: '🔍 Find/cancel other booking' },
  ci_manual_search_title: { th: 'ค้นหา booking (ทุกวันที่ ไม่ต้องรอ 5 วัน)', en: 'Search bookings (any date — no 5-day wait)' },
  ci_manual_search_placeholder: { th: 'พิมพ์ชื่อแขก, resId, หรือเลขห้อง...', en: 'Type guest name, resId, or room number...' },
  ...
  sp_col_photo:            { th: 'รูป', en: 'Photo' },
  sp_photo_upload_failed:  { th: 'อัปโหลดรูปไม่สำเร็จ ลองใหม่อีกครั้ง', en: 'Upload failed, please try again' },
  sp_photo_delete_confirm: { th: 'ลบรูปนี้หรือไม่?', en: 'Delete this photo?' },
  ...
  push_enabled_alert:      { th: '✅ เปิดแจ้งเตือนเรียบร้อย ลองรอ push ครั้งถัดไปได้เลย', en: '✅ Notifications enabled. You should receive the next push.' },
  push_denied_alert:       { th: '❌ ยังไม่ได้อนุญาตแจ้งเตือน — เช็ค Settings > Notifications > Loft Admin', en: '❌ Notification permission denied — check Settings > Notifications > Loft Admin' },
  push_failed_alert:       { th: '❌ เปิดแจ้งเตือนไม่สำเร็จ ลองใหม่อีกครั้ง', en: '❌ Failed to enable notifications. Try again.' },
