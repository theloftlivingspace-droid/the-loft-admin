...
const DICT: Record<string, { th: string; en: string }> = {
  ...
  ci_extend_helper_text:{ th: 'ใช้เมื่อ Little Hotelier เปลี่ยนวันให้แล้วแต่ไม่ส่งอีเมลแจ้ง ระบบจะอัปเดต Sheet1, ซิงก์ Apartmentery (ถ้ามี booking แล้ว) และแจ้งกลุ่มแม่บ้านให้อัตโนมัติ', en: 'Use this when Little Hotelier already changed the date but sent no notification email. This updates Sheet1, syncs Apartmentery (if a booking already exists there), and notifies the housekeeping group automatically.' },
